...
class BenchmarkScene:
    ...
    def __init__(self, scene_manager):
        ...
        self.input_engines.set_default("AIbrain_shallow:shallow.npz; AIbrain_Zero:zero.npz;AIbrain_QERQ:QERQ.npz;ONEX:ONEX.npz;AIbrain_FAST:FAST.npz;AIbrain_ASDF:asdf.npz;SNOW:SNOW.npz;AIbrain_vers:vers.npz;AIbrain_LGBT:LGBT.npz;AIbrain_maie:maie.npz")
